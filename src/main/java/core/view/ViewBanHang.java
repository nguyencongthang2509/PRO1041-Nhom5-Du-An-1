...
public class ViewBanHang extends javax.swing.JPanel implements Runnable, ThreadFactory {
        ...
        do {
            ...
            if (result != null) {
                try {
                    ...
                    if (rowHoaDon == -1) {
                        JOptionPane.showMessageDialog(this, "Má»�i chá»�n hÃ³a Ä‘Æ¡n");
                        continue;
                    }
                    ...
                    if (hoaDonChiTietCheck != null) {
                        Object[] options = {"ThÃªm sá»‘ lÆ°á»£ng", "Giáº£m sá»‘ lÆ°á»£ng", "Há»§y"};
                        int resultOption = JOptionPane.showOptionDialog(this,
                                "Sáº£n pháº©m nÃ y Ä‘Ã£ cÃ³ trong giá»� hÃ ng, báº¡n muá»‘n lÃ m gÃ¬?",
                                "XÃ¡c nháº­n",
                        ...
                        if (resultOption == 0 || resultOption == 1) {
                            String soLuongThayDoiStr = JOptionPane.showInputDialog(this, "Nháº­p sá»‘ lÆ°á»£ng: ");
                            ...
                            try {
                                ...
                                if (soLuongThayDoi < 0) {
                                    JOptionPane.showMessageDialog(this, "Sá»‘ lÆ°á»£ng khÃ´ng thá»ƒ Ã¢m");
                                    continue;
                                }
                            } catch (Exception e) {
                            ...
                            if (resultOption == 0) {
                                if (soLuongThayDoi > bhChiTietSPCheck.getSoLuongTon() - hoaDonChiTietCheck.getSoLuong()) {
                                    JOptionPane.showMessageDialog(this, "KhÃ´ng Ä‘Æ°á»£c vÆ°á»£t sá»‘ lÆ°á»£ng tá»“n");
                                    continue;
                                }
                                soLuongThayDoi = soLuongThayDoi;
                            } else {
                                if (soLuongThayDoi > hoaDonChiTietCheck.getSoLuong()) {
                                    JOptionPane.showMessageDialog(this, "Sá»‘ lÆ°á»£ng sau khi giáº£m khÃ´ng Ä‘Æ°á»£c Ã¢m");
                                    continue;
                                }
                                if (soLuongThayDoi == hoaDonChiTietCheck.getSoLuong()) {
                    ...
                    if (hoaDonChiTietCheck == null) {
                        String inputSoLuong = JOptionPane.showInputDialog(this, "Nháº­p sá»‘ lÆ°á»£ng", "0");
                        ...
                        try {
                            ...
                            if (soLuong < 0 || soLuong > bhChiTietSPCheck.getSoLuongTon()) {
                                JOptionPane.showMessageDialog(this, "Sá»‘ lÆ°á»£ng khÃ´ng Ä‘Æ°á»£c Ã¢m, khÃ´ng lá»›n hÆ¡n sá»‘ lÆ°á»£ng tá»“n");
                                continue;
                            }
                        } catch (Exception e) {
                            JOptionPane.showMessageDialog(this, "Sá»‘ lÆ°á»£ng pháº£i lÃ  sá»‘");
    ...
    private void loadDataToTableSP(List<BhChiTietSPResponse> list) {
        ...
        for (BhChiTietSPResponse xx : list) {
            ...
            modelSanPham.addRow(new Object[]{xx.getMaCTSP(), xx.getTenSP(), xx.getMauSac(), xx.getSize(), xx.getHang(), xx.getSoLuongTon(), xx.getDonGia() + " VnÄ‘", giaBan + " VnÄ‘"});
        }
    }
    ...
    private void initComponents() {
        ...
        tblKhachHang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ£ KH", "TÃªn KH", "SDT", "Email", "Giá»›i tÃ­nh", "Ä�á»‹a chá»‰"
            }
        ) {
        ...
        jTabbedPane3.addTab("Danh sÃ¡ch khÃ¡ch hÃ ng", jPanel10);
        ...
        jTabbedPane3.addTab("Chá»‰nh sá»­a ttin khÃ¡ch hÃ ng", jPanel11);

        jButton1.setText("Chá»�n");
        ...
        KhachHangView.setTitle("Danh sÃ¡ch khÃ¡ch hÃ ng");
        ...
        btnChonKhachHang.setText("Chá»�n");
        ...
        jTabbedPane4.addTab("Danh sÃ¡ch khÃ¡ch hÃ ng", jPanel9);
        ...
        jRadioButton2.setText("Ná»¯");

        jTextField11.setText("Ä�á»‹a chá»‰:");
        ...
        jButton2.setText("ThÃªm");

        jButton3.setBackground(new java.awt.Color(153, 204, 255));
        jButton3.setText("Sá»­a");
        ...
        jTabbedPane4.addTab("Chá»‰nh sá»­a thÃ´ng tin khÃ¡ch hÃ ng", jPanel13);
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh sÃ¡ch sáº£n pháº©m", javax.swing.border.TitledBorder.LEADING, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 16))); // NOI18N
        ...
        tblSanPham.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ£ SP", "TÃªn SP", "MÃ u sáº¯c", "Size", "HÃ£ng", "SL tá»“n", "Ä�Æ¡n giÃ¡", "GiÃ¡ bÃ¡n"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jLabel1.setText("MÃ u sáº¯c:");

        jLabel2.setText("Size:");

        jLabel30.setText("HÃ£ng:");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Giá»� hÃ ng", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 16))); // NOI18N
        ...
        tblGioHang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ£ SP", "TÃªn SP", "Ä�Æ¡n giÃ¡", "Sá»‘ lÆ°á»£ng", "Giáº£m giÃ¡", "GiÃ¡ bÃ¡n", "ThÃ nh tiá»�n"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        if (tblGioHang.getColumnModel().getColumnCount() > 0) {
            ...
            tblGioHang.getColumnModel().getColumn(1).setPreferredWidth(35);
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "HÃ³a Ä‘Æ¡n chá»�", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 16))); // NOI18N
        ...
        tblHoaDonCho.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ£ HÄ�", "NgÃ y táº¡o", "NhÃ¢n viÃªn", "KhÃ¡ch hÃ ng", "HÃ¬nh thá»©c", "Tráº¡ng thÃ¡i"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Ä�Æ¡n hÃ ng", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 16))); // NOI18N

        jPanel17.setBackground(new java.awt.Color(255, 255, 255));

        jPanel15.setBackground(new java.awt.Color(255, 255, 255));
        jPanel15.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ThÃ´ng tin khÃ¡ch hÃ ng", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 15))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel3.setText("MÃ£ KH:");

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel4.setText("TÃªn KH:");
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ThÃ´ng tin hÃ³a Ä‘Æ¡n", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 15))); // NOI18N

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel5.setText("MÃ£ hÃ³a Ä‘Æ¡n:");

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel6.setText("TÃªn nhÃ¢n viÃªn:");

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel7.setText("Tá»•ng tiá»�n:");

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel8.setText("Giáº£m giÃ¡:");

        jLabel9.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel9.setText("Thanh toÃ¡n:");

        jLabel10.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel10.setText("Tiá»�n khÃ¡ch Ä‘Æ°a:");

        jLabel11.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel11.setText("Tiá»�n thá»«a:");

        jLabel12.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel12.setText("HT thanh toÃ¡n:");
        ...
        cboHTThanhToanTaiQuay.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tiá»�n máº·t", "Chuyá»ƒn khoáº£n", "Káº¿t há»£p" }));
        ...
        lblTaoHoaDonTaiQuay.setText("Táº¡o hÃ³a Ä‘Æ¡n");
        ...
        lblThanhToanTaiQuay.setText("Thanh toÃ¡n");
        ...
        jLabel19.setText("Tiá»�n khÃ¡ch CK:");
        ...
        tbpDonHang.addTab("Táº¡i quáº§y", jPanel17);
        ...
        jPanel19.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ThÃ´ng tin ngÆ°á»�i nháº­n", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 15))); // NOI18N

        jLabel13.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel13.setText("Há»� tÃªn:");
        ...
        jPanel20.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ThÃ´ng tin ngÆ°á»�i ship", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 15))); // NOI18N

        jLabel17.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel17.setText("Há»� tÃªn:");
        ...
        jPanel21.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ThÃ´ng tin hÃ³a Ä‘Æ¡n", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 15))); // NOI18N
        ...
        cboHTThanhToanDatHang.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tiá»�n máº·t", "Chuyá»ƒn khoáº£n", "Káº¿t há»£p" }));
        ...
        btnTaoHoaDonDatHang.setText("Táº¡o hÃ³a Ä‘Æ¡n");
        ...
        btnDangGiaoDatHang.setText("Ä�ang giao");
        ...
        btnDaGiaoDatHang.setText("Ä�Ã£ giao");
        ...
        tbpDonHang.addTab("Ä�áº·t hÃ ng", jPanel18);
        ...
        jPanel14.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "QuÃ©t mÃ£ váº¡ch sáº£n pháº©m", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 16))); // NOI18N
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        try {
            int confirm = JOptionPane.showConfirmDialog(this, "Báº¡n cÃ³ cháº¯c muá»‘n xÃ³a táº¥t cáº£ sáº£n pháº©m khá»�i giá»� hÃ ng khÃ´ng?");
    ...
    private void btnChonKhachHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChonKhachHangActionPerformed
        ...
        if (index == -1) {
            JOptionPane.showMessageDialog(this, "HÃ£y chá»�n khÃ¡ch hÃ ng");
            return;
        }
    ...
    private void tblGioHangKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblGioHangKeyReleased
        try {
            ...
            if (soLuongCurrent > bhHoaDonChiTietResponse.getSoLuongTon()) {
                ...
                JOptionPane.showMessageDialog(this, "Sá»‘ lÆ°á»£ng tá»“n khÃ´ng Ä‘á»§");
                return;
            }
            if (soLuongCurrent < 0) {
                tblGioHang.setValueAt(soLuongCu, row, 3);
                JOptionPane.showMessageDialog(this, "Sá»‘ lÆ°á»£ng khÃ´ng Ä‘Æ°á»£c Ã¢m");
                return;
            }
            if (soLuongCurrent == 0) {
    ...
    private void btnXoa1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoa1ActionPerformed
        try {
            ...
            if (rowHDCT == -1) {
                JOptionPane.showMessageDialog(this, "HÃ£y chá»�n sáº£n pháº©m muá»‘n xÃ³a");
                return;
            }
            int confirm = JOptionPane.showConfirmDialog(this, "Báº¡n cÃ³ cháº¯c muá»‘n xÃ³a sáº£n pháº©m nÃ y khá»�i giá»� hÃ ng khÃ´ng ?");
            if (confirm != JOptionPane.YES_OPTION) {
                return;
            }
    ...
    private void btnTaoHoaDonDatHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTaoHoaDonDatHangActionPerformed
        try {
            ...
            listHoaDon = banHangService.getAllResponseHD(nhanVien.getId());
            loadDataToHoaDon(listHoaDon);
            JOptionPane.showMessageDialog(this, "Táº¡o hÃ³a Ä‘Æ¡n thÃ nh cÃ´ng");
            tblHoaDonCho.setRowSelectionInterval(0, 0);
    ...
    private void cboHTThanhToanTaiQuayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboHTThanhToanTaiQuayActionPerformed
        ...
        if (cboHTThanhToanTaiQuay.getSelectedIndex() == 1) {
            ...
            txtTienThuaTaiQuay.setText("0 VnÄ‘");
        }
    ...
    private void txtTienKhachDuaTaiQuayCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtTienKhachDuaTaiQuayCaretUpdate
        try {
            ...
            if (tienKhachDua.compareTo(BigDecimal.ZERO) == -1) {
                JOptionPane.showMessageDialog(this, "Tiá»�n khÃ¡ch Ä‘Æ°a pháº£i > 0");
                return;
            }
            tinhTongTien();
        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Tiá»�n khÃ¡ch Ä‘Æ°a pháº£i lÃ  sá»‘");
        }
    ...
    private void lblThanhToanTaiQuayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblThanhToanTaiQuayMouseClicked
        try {
            if (cboHTThanhToanTaiQuay.getSelectedIndex() == 0 && txtTienKhachDuaTaiQuay.getText().trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "HÃ£y nháº­p tiá»�n khÃ¡ch Ä‘Æ°a");
                return;
            }
            ...
            if (new BigDecimal(arrayCheck[0].replace(",", "")).compareTo(BigDecimal.ZERO) == -1) {
                JOptionPane.showMessageDialog(this, "Tiá»�n khÃ¡ch Ä‘Æ°a khÃ´ng Ä‘á»§");
                return;
            }
            int rowHoaDon = tblHoaDonCho.getSelectedRow();
            BhHoaDonResponse bhHoaDonResponse = listHoaDon.get(rowHoaDon);
            if (bhHoaDonResponse.getHinhThucGiaoHang() == 0) {
                ...
                int confirm = JOptionPane.showConfirmDialog(this, "Báº¡n cÃ³ muá»‘n in hÃ³a Ä‘Æ¡n khÃ´ng?");
                if (confirm == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "In hÃ³a Ä‘Æ¡n thÃ nh cÃ´ng");
                    } catch (Exception e) {
                        JOptionPane.showMessageDialog(this, "In hÃ³a Ä‘Æ¡n tháº¥t báº¡i");
                    }
                    clearForm();
                } else {
                    clearForm();
    ...
    private void cboHTThanhToanDatHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboHTThanhToanDatHangActionPerformed
        ...
        if (cboHTThanhToanDatHang.getSelectedIndex() == 1) {
            ...
            txtTienThuaDatHang.setText("0 VnÄ‘");
        }
    ...
    private void btnDangGiaoDatHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangGiaoDatHangActionPerformed
        try {
            ...
            if (tenNguoiNhan.isEmpty() || sdtNguoiNhan.isEmpty() || diaChi.isEmpty()
                ...
                JOptionPane.showMessageDialog(this, "HÃ£y nháº­p Ä‘áº§y Ä‘á»§ thÃ´ng tin cá»§a ngÆ°á»�i nháº­n vÃ  ngÆ°á»�i ship");
                return;
            }
            if (txtTienShip.getText().trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "HÃ£y nháº­p tiá»�n ship");
                return;
            }
    ...
    private void btnDaGiaoDatHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDaGiaoDatHangActionPerformed
        try {
            ...
            if (bhHoaDonResponse.getHinhThucGiaoHang() == 1 && bhHoaDonResponse.getTrangThai() == 3) {
                ...
                loadDataToHoaDon(listHoaDon);
                clearFormDatHang();
                JOptionPane.showMessageDialog(this, "Cáº­p nháº­t hÃ³a Ä‘Æ¡n thÃ nh cÃ´ng");
            } else {
                JOptionPane.showMessageDialog(this, "HÃ³a Ä‘Æ¡n khÃ´ng phÃ¹ há»£p Ä‘á»ƒ sá»­ dá»¥ng chá»©c nÄƒng nÃ y");
                return;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void btnHuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHuyActionPerformed
        try {
            int rowHoaDon = tblHoaDonCho.getSelectedRow();
            if (rowHoaDon == -1) {
                JOptionPane.showMessageDialog(this, "HÃ£y chá»�n hÃ³a Ä‘Æ¡n chá»� báº¡n muá»‘n há»§y !");
                return;
            }
            BhHoaDonResponse bhHoaDonResponse = listHoaDon.get(rowHoaDon);
            if (bhHoaDonResponse.getTrangThai() != 0) {
                JOptionPane.showMessageDialog(this, "Tráº¡ng thÃ¡i cá»§a hÃ³a Ä‘Æ¡n khÃ´ng phÃ¹ há»£p");
                return;
            }
            int confirm = JOptionPane.showConfirmDialog(this, "Báº¡n cÃ³ cháº¯c muá»‘n há»§y hÃ³a Ä‘Æ¡n chá»� nÃ y khÃ´ng?");
            if (confirm != JOptionPane.YES_OPTION) {
                return;
            }
            HoaDon hoaDon = banHangService.findByIdHoaDon(bhHoaDonResponse.getId());
            ...
            listHoaDon = banHangService.getAllResponseHD(nhanVien.getId());
            loadDataToHoaDon(listHoaDon);
            JOptionPane.showMessageDialog(this, "Há»§y hÃ³a Ä‘Æ¡n chá»� thÃ nh cÃ´ng!");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void tinhTongTien() {
        try {
            ...
            if (bhHoaDonResponse.getHinhThucGiaoHang() == 0) {
                ...
                txtTongTienTaiQuay.setText(df.format(tong) + " VnÄ‘");
                txtGiamGiaTaiQuay.setText(df.format(giamGia) + " VnÄ‘");
                BigDecimal tienCanTra = tong.subtract(giamGia);
                txtThanhToanTaiQuay.setText(df.format(tienCanTra) + " VnÄ‘");
                if (cboHTThanhToanTaiQuay.getSelectedIndex() == 1) {
                    txtTienKhachCKTaiQuay.setText(txtThanhToanTaiQuay.getText());
                    return;
                }
                ...
                if (tienThua.compareTo(BigDecimal.ZERO) == -1) {
                    txtTienThuaTaiQuay.setText(tienThua + " VnÄ‘");
                } else {
                    txtTienThuaTaiQuay.setText(df.format(tienThua) + " VnÄ‘");
                }
            } else {
                try {
                    if (!txtTienShip.getText().trim().isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(this, "Tiá»�n ship pháº£i lÃ  sá»‘");
                ...
                DecimalFormat df = new DecimalFormat("#,###");
                txtTongTienDatHang.setText(df.format(tong) + " VnÄ‘");
                txtGiamGiaDatHang.setText(df.format(giamGia) + " VnÄ‘");
                BigDecimal tienCanTra = tong.subtract(giamGia).add(tienShip);
                txtThanhToanDatHang.setText(df.format(tienCanTra) + " VnÄ‘");
                if (cboHTThanhToanDatHang.getSelectedIndex() == 1) {
                    txtTienKhachCKDatHang.setText(txtThanhToanDatHang.getText());
                    txtTienThuaDatHang.setText("0 VnÄ‘");
                    return;
                ...
                tienThua = tienKhachDua.subtract(tienCanTra);
                if (tienThua.compareTo(BigDecimal.ZERO) == -1) {
                    txtTienThuaDatHang.setText(tienThua + " VnÄ‘");
                } else {
                    txtTienThuaDatHang.setText(df.format(tienThua) + " VnÄ‘");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
