...
public class InsertData {
    ...
    public static void main(String[] args) {
        ...
        chiTietSP3.setKhuyenMai(khuyenMai1);
        ...
        chiTietSP4.setKhuyenMai(khuyenMai1);
        ...
        chiTietSP5.setKhuyenMai(khuyenMai);
        ...
        chiTietSP6.setKhuyenMai(khuyenMai);
        ...
        chiTietSP7.setKhuyenMai(khuyenMai1);
